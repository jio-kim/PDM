...
import com.ssangyong.common.remote.WebServiceCallUtil;
...
public class SDVBOPUtilities {
    ...
    public static HashMap<String, String> getDescriptionFromVariant(ArrayList<String> values) {
        ...
        for (int i = 0; values!=null && i < values.size(); i++) {
        	...
        	if(value!=null && value.trim().length()>0){
        		...
        		try {
        			list = (ArrayList<HashMap<String, String>>) webServiceCallUtil.execute("com.ssangyong.service.VariantService", "getVariantValueDesc", ds);
        		} catch (Exception e) {
        			e.printStackTrace();
        		}
        	}
	...
	public static ArrayList<EndItemData> findReplacedEndItems(String targetUid, String productId) throws Exception {
        ...
        String serviceClass = "com.ssangyong.service.SYMCBOPService";
