...
public class TcConstants {
    ...
    // ================================================
    // ITEM CLASS TYPE
    public static final String S7_PRODUCT = "S7_Product";
    public static final String S7_VARIANT = "S7_Variant";
    public static final String S7_FUNCTION = "S7_Function";
    public static final String S7_FUNCTION_MAST = "S7_FunctionMast";
    public static final String S7_VEH_PART = "S7_Vehpart";
    public static final String S7_STD_PART = "S7_Stdpart";
    public static final	String S7_MATPARTTYPE = "S7_Material";
    public static final String S7_SOFTPARTTYPE = "S7_Software";
    public static final String S7_PREPRODUCTTYPE = "S7_PreProduct";
    public static final String S7_PREFUNCTIONTYPE = "S7_PreFunction";
    public static final String S7_PREFUNCMASTERTYPE = "S7_PreFuncMaster";
    public static final String S7_PREVEHICLEPARTTYPE = "S7_PreVehPart";
    public static final String S7_DESIGNCONCEPTTYPE = "S7_DesignConcept";
    public static final String S7_SYSTEMCONCEPTTYPE = "S7_SystemConcept";
    public static final String S7_PRECCNTYPE = "S7_PreCCN";
    public static final String S7_PREPROJECTTYPE = "S7_PreProject";

    // REVISION CLASS TYPE
    public static final String S7_PRODUCT_REVISION = "S7_ProductRevision";
    public static final String S7_VARIANT_REVISION = "S7_VariantRevision";
    public static final String S7_FUNCTION_REVISION = "S7_FunctionRevision";
    public static final String S7_FUNCTION_MAST_REVISION = "S7_FunctionMastRevision";
    public static final String S7_VEH_PART_REVISION = "S7_VehpartRevision";
    public static final String S7_STD_PART_REVISION = "S7_StdpartRevision";
    public static final String S7_MATPARTREVISIONTYPE =  "S7_MaterialRevision";
    public static final String S7_SOFTPARTREVISIONTYPE = "S7_SoftwareRevision";
    public static final String S7_PREPRODUCTREVISIONTYPE = "S7_PreProductRevision";
    public static final String S7_PREFUNCTIONREVISIONTYPE = "S7_PreFunctionRevision";
    public static final String S7_PREFUNCMASTERREVISIONTYPE = "S7_PreFuncMasterRevision";
    public static final String S7_PREVEHICLEPARTREVISIONTYPE = "S7_PreVehPartRevision";
    public static final String S7_DESIGNCONCEPTREVISIONTYPE = "S7_DesignConceptRevision";
    public static final String S7_SYSTEMCONCEPTREVISIONTYPE = "S7_SystemConceptRevision";
    public static final String S7_PRECCNREVISIONTYPE = "S7_PreCCNRevision";
    public static final String S7_PREPROJECTREVISIONTYPE = "S7_PreProjectRevision";
    public static final String S7_OSPECREVISIONTYPE = "S7_OspecSetRevision";
    
    public static final String ITEM_TYPE_PREPRODUCT = "Pre-Product";
    public static final String ITEM_TYPE_PREFUNCTION = "Pre-Function";
    public static final String ITEM_TYPE_PREFUNCTIONMASTER = "Pre-Function Master";
    ...
    public static final String TYPE_ITEM_MASTER = "ItemMaster";
    public static final String TYPE_ITEM_REVISION_MASTER = "ItemRevisionMaster";
    public static final String TYPE_FORM = "Form";
    public static final String TYPE_URL = "Web Link";
    
    // BOMVIEW REVISION RULE - LAST REVISION
    public static final String BOMVIEW_LATEST_RELEASED = "Latest Released";
    public static final String BOMVIEW_LATEST_WORKING = "Latest Working";
    ...
    public static final String TYPE_DATASET_CATCACHE ="CATCache";
    ...
    public static final String TYPE_NR_CATCACHE = "catcgr";
    ...
    // File Log Return Char
    public static final String TEXT_RETURN = "\r\n";
