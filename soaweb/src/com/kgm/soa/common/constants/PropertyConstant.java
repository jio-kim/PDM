...
public class PropertyConstant {
    ...
    public static final String ATTR_NAME_ITEM_MASTER_TAG = "item_master_tag";
    public static final String ATTR_NAME_DATASET_TYPE ="dataset_type";
    public static final String ATTR_NAME_DATASET_TYPE_NAME ="datasettype_name";
    public static final String ATTR_NAME_REF_LIST = "ref_list";
    public static final String ATTR_NAME_REF_NAMES = "ref_names";
	...
	public static final String ATTR_NAME_BUDGETCODE = "s7_BUDGET_CODE";
	...
	public static final String ATTR_NAME_ORIGIN_PROJECT = "s7_ORIGIN_PROJECT"; //
	public static final String ATTR_NAME_DESIGN_CONCEPT = "s7_DESIGN_CONCEPT_U"; //
	public static final String ATTR_NAME_EST_COST_MATERIAL = "s7_EST_COST_MATERIAL"; //
	public static final String ATTR_NAME_TARGET_COST_MATERIAL = "s7_TARGET_COST_MATERIAL";
	public static final String ATTR_NAME_SELECTED_COMPANY = "s7_SELECTED_COMPANY"; //
	public static final String ATTR_NAME_CON_DWG_PLAN = "s7_CON_DWG_PLAN"; // Concept Dwg
	public static final String ATTR_NAME_CON_DWG_PERFORMANCE = "s7_CON_DWG_PERFORMANCE"; // Concept Dwg
	public static final String ATTR_NAME_CON_DWG_TYPE = "s7_CON_DWG_TYPE"; // Concept Dwg 2D/3D
	public static final String ATTR_NAME_DWG_DEPLOYABLE_DATE = "s7_DWG_DEPLOYABLE_DATE"; //
	public static final String ATTR_NAME_PRD_DWG_PLAN = "s7_PRD_DWG_PLAN"; //
	public static final String ATTR_NAME_PRD_DWG_PERFORMANCE = "s7_PRD_DWG_PERFORMANCE"; //
	
	public static final String ATTR_NAME_CIC_DEPT_NM = "s7_CIC_DEPT_NM"; // CIC
	public static final String ATTR_NAME_PRT_TOOLG_INVESTMENT = "s7_PRT_TOOLG_INVESTMENT"; //
	public static final String ATTR_NAME_PRD_TOOL_COST = "s7_PRD_TOOL_COST"; //
	public static final String ATTR_NAME_PRD_SERVICE_COST = "s7_PRD_SERVICE_COST"; //
	public static final String ATTR_NAME_PRD_SAMPLE_COST = "s7_PRD_SAMPLE_COST"; //
	public static final String ATTR_NAME_TOTAL = "s7_TOTAL"; //
	public static final String ATTR_NAME_PUR_DEPT_NM = "s7_PUR_DEPT_NM"; //
	public static final String ATTR_NAME_PUR_RESPONSIBILITY = "s7_PUR_RESPONSIBILITY"; //
	public static final String ATTR_NAME_EMPLOYEE_NO = "s7_EMPLOYEE_NO"; //
    ...
    public static final String ATTR_NAME_VEH_TYPE_REF = "s7_Vehpart_TypedReference";
	...
	public static final String ATTR_NAME_BL_OCC_UID = "bl_occ_fnd0objectId";
	...
	public static final String ATTR_NAME_BL_ITEM_REVISION = "bl_item_revision";
	...
	public static final String ATTR_NAME_BL_CHILD_LINES = "bl_child_lines";
	public static final String ATTR_NAME_BL_PARENT = "bl_parent";
	public static final String ATTR_NAME_BL_IS_PACKED = "bl_is_packed";
	public static final String ATTR_NAME_BL_PACKED_LINES = "bl_packed_lines";
	
	public static final String ATTR_NAME_BL_DVP_NEEDED_QTY = "S7_DVP_NEEDED_QTY"; // DVP SAMPLE
	public static final String ATTR_NAME_BL_DVP_USE = "S7_DVP_USE"; // DVP SAMPLE
	public static final String ATTR_NAME_BL_DVP_REQ_DEPT = "S7_DVP_REQ_DEPT"; // DVP SAMPLE

	public static final String ATTR_NAME_BL_ENG_DEPT_NM = "S7_ENG_DEPT_NM"; // 
	public static final String ATTR_NAME_BL_ENG_RESPONSIBLITY = "S7_ENG_RESPONSIBLITY"; //
	...
	// ATTRIBUTE - USER
	public static final String ATTR_NAME_USER_NAME = "user_name";
	public static final String ATTR_NAME_DEFAULT_GROUP = "default_group";
	public static final String ATTR_NAME_DEPT_NAME = "PA6";
	public static final String ATTR_NAME_TEL = "PA10";
    public static final String ATTR_NAME_USER_ID = "user_id";
    
    public static final String ATTR_NAME_CHECKED_OUT = "checked_out";
    public static final String ATTR_NAME_CHECKED_OUT_CHANGE_ID = "checked_out_change_id";
    public static final String ATTR_NAME_CHECKED_OUT_USER = "checked_out_user";
    public static final String ATTR_NAME_CHECKED_OUT_DATE = "checked_out_date";
