...
import com.kgm.commands.ec.eco.admincheck.dialog.ECOAdminCheckDialog;
import com.kgm.commands.ec.search.ECOSearchDialog;
import com.kgm.commands.ec.search.FileAttachmentComposite;
import com.kgm.commands.ec.search.SearchECIDialog;
import com.kgm.commands.ec.search.SearchECRDialog;
import com.kgm.commands.ec.search.SearchUserDialog;
import com.kgm.commands.ec.workflow.ECOProcessCommand;
import com.kgm.commands.workflow.SYMCDecisionDialog;
import com.kgm.common.SYMCClass;
import com.kgm.common.SYMCDateTimeButton;
import com.kgm.common.SYMCYesNoRadio;
...
//			final ArrayList<SYMCECODwgData> ecoBdata = (ArrayList<SYMCECODwgData>) remote.execute("com.kgm.service.ECOHistoryService", "selectECODwgList", dss);
//			ecoBCount = ecoBdata.size();
			...
			if(targetComponent !=null)
			{
			    ...
			    ecoBdata = (ArrayList<SYMCECODwgData>) remote.execute("com.kgm.service.ECOHistoryService", "selectECODwgList", dss);
			}
...
//					SYMCRemoteUtil remote = new SYMCRemoteUtil();
					...
					try{
						...
						ArrayList result = (ArrayList)remote.execute("com.kgm.service.ModuleBomValidationService", "getModulePart", ds);
...
//		textGridData = new GridData (168, SWT.DEFAULT);
	...
	public void createDesignPanel() {
		...
		// [20240522][UPGRADE] Validation Check 추가
