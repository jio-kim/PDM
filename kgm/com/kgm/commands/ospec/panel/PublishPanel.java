...
import com.kgm.commands.ospec.OSpecBomCompareDlg;
import com.kgm.commands.ospec.OSpecConditionSetDlg;
...
//					ds.put("COL1", str);
//					
//					remoteQuery.execute("com.kgm.service.SMTestService", "insertTest", ds);
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//			}
...
//			}
	...
	private void updateOpGroupCondition(String condition) throws Exception
	{
			...
			for(OpGroup opGroup :selectedOpGroup)
			{
		        ...
		        remote.execute("com.kgm.service.OSpecService", "updateOpGroupCondition", ds);
			}
	}	
	...
	private String getOpGroupCondition(OpGroup opGroup) throws Exception {
		...
		try {
			...
			ds.put("OWNER", opGroup.getOwner());
			ds.put("GROUP_NAME", opGroup.getOpGroupName());
			String condition = (String) remote.execute("com.kgm.service.OSpecService", "getOpGroupCondition", ds);
			return condition;
		} catch (Exception e) {
			throw e;
		}
