...
public class OSpec {
	...
	/**
	 * [SR없음][20150907][jclee] Trim Seq No 추가를 위해 정렬되지 않은 Trim List 반환
	 * BUG 존재. 사용 X
	 */
	public ArrayList<OpTrim> getTrimListWithoutSort(){
	...
	public ArrayList<Option> getOptionList(){
		...
		Collection<ArrayList<Option>> collection = options.values();
