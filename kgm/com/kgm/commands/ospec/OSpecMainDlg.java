...
import com.kgm.commands.ospec.panel.ComparablePanel;
import com.kgm.commands.ospec.panel.OSpecTable;
import com.kgm.commands.ospec.panel.OptionGroupManagerPanel;
import com.kgm.commands.ospec.panel.PublishPanel;
import com.kgm.commands.ospec.panel.WorkspacePanel;
...
public class OSpecMainDlg extends AbstractAIFDialog {
	...
	public void deleteOptionGroup(OpGroup opGroup) throws Exception{
		...
		try {
			...
			remote.execute("com.kgm.service.OSpecService", "deleteOptionGroup", ds);
	...
	public ArrayList<OpValueName> getOptionGroupDetail(String groupName, boolean bOnlyOwn) throws Exception{
		...
		ds.put("PROJECT", ospec.getProject());
		try {
			ArrayList<HashMap<String, String>> list = (ArrayList<HashMap<String, String>>)remote.execute("com.kgm.service.OSpecService", "getOptionGroupDetail", ds);
	...
	public ArrayList<OpGroup> getOptionGroup(boolean bOnlyOwn) throws Exception{
		...
		ds.put("PROJECT", ospec.getProject());
		try {
			ArrayList<HashMap<String, String>> list = (ArrayList<HashMap<String, String>>)remote.execute("com.kgm.service.OSpecService", "getOptionGroup", ds);
			for( int i = 0; list != null && i < list.size(); i++){
				HashMap<String, String> map = list.get(i);
...
//		HashMap<String, HashMap<String, ArrayList<OpGroup>>>  result = new HashMap();// HashMap<project, HashMap<opValue, ArrayList<OpGroup>>>
		...
		try {
			HashMap<String, ArrayList> resultList = (HashMap<String, ArrayList>)remote.execute("com.kgm.service.OSpecService", "getReferedOptionGroup", ds);
	...
	private ArrayList getTrim(String ospecNo) throws Exception{
		...
		try {
			...
			ArrayList<HashMap<String,Object>> trims = (ArrayList<HashMap<String,Object>>)remote.execute("com.kgm.service.OSpecService", "getOspecTrim", ds);
...
//				String optionCategory = OpUtil.getCategory(opCode);
	...
	public ArrayList<HashMap<String, String>> getFuntionList() throws Exception{
		...
		try {
			ds.put("PROJECT", ospec.getProject());
			ArrayList<HashMap<String, String>> functionList = (ArrayList<HashMap<String, String>>)remote.execute("com.kgm.service.OSpecService", "getFunctionList", ds);
			return functionList;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			throw e;
