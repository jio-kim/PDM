...
import com.kgm.commands.namegroup.model.PngProd;
...
//		Vector<String> header = prodVec;
	...
	private HashMap<String, HashMap<String, Boolean>> getAssignData() throws Exception{
		...
		ds.put("PARAM", null);
		ArrayList<HashMap<String, Object>> assignList = (ArrayList<HashMap<String, Object>>)remote.execute("com.kgm.service.PartNameGroupService", "getPngAssign", ds);
...
//				System.out.println("[" + i + ", " + j + "] = " + bUse);
		...
		try {
			...
			remote.execute("com.kgm.service.PartNameGroupService", "savePngAssign", ds);
