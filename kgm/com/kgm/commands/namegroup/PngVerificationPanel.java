...
import com.kgm.commands.namegroup.dao.PartNameGroupDao;
import com.kgm.commands.namegroup.model.NameGroupCountResult;
import com.kgm.commands.namegroup.model.PngCondition;
import com.kgm.commands.namegroup.model.PngMaster;
import com.kgm.commands.namegroup.model.SpecHeader;
import com.kgm.commands.namegroup.model.SpecOptionChangeInfo;
import com.kgm.commands.ospec.OSpecImportDlg;
...
//			System.out.println("End Time : "+ new Date());
	...
	private ArrayList getEndItemNameList(String product, String type, String puid, String rowkey) throws Exception {
		...
		try {
			...
			ArrayList<HashMap<String, Object>> list = (ArrayList<HashMap<String, Object>>) remote.execute("com.kgm.service.PartNameGroupService", "getEndItemNameList", ds);
	...
	private ArrayList getSpecEndItemNameList(String product, String type, String puid, String rowkey) throws Exception {
		...
		ds.put("ROWKEY", rowkey);
		try {
			ArrayList<HashMap<String, Object>> list = (ArrayList<HashMap<String, Object>>) remote.execute("com.kgm.service.PartNameGroupService", "getSpecEndItemNameList", ds);
			return list;
		} catch (Exception e) {
			throw e;
		}
	...
	private String getSpec(String type, String puid) throws Exception {
		...
		try {
			...
			String specStr = (String) remote.execute("com.kgm.service.PartNameGroupService", "getSpec", ds);
		...
		try {
			...
			try {
				...
				if (type.equals("USER SPEC")) {
					spec = (ArrayList<HashMap<String, Object>>) remote.execute("com.kgm.service.PartNameGroupService", "getUserSpecWithCategory", ds);
				} else if (type.equals("BUILD SPEC")) {
					spec = (ArrayList<HashMap<String, Object>>) remote.execute("com.kgm.service.PartNameGroupService", "getBuildSpecWithCategory", ds);
				} else if (type.equals("PLAN SPEC") || type.equals("RESULT SPEC")) {
					spec = (ArrayList<HashMap<String, Object>>) remote.execute("com.kgm.service.PartNameGroupService", "getPlanResultSpecWithCategory", ds);
				}
				return spec;
			} catch (Exception e) {
				MessageBox.post(e);
...
//			System.out.println( "sPUID : " + sPUID);
		...
		DataSet ds = new DataSet();
		ds.put("DATA", null);
		ArrayList<HashMap<String, String>> alAllOptions = (ArrayList<HashMap<String, String>>)remote.execute("com.kgm.service.VariantService", "getVariantValueDesc", ds);
	...
	private void exportXSSF(File selectedFile, boolean isOnlyError) throws Exception {
		...
		DataSet ds = new DataSet();
		ds.put("DATA", null);
		ArrayList<HashMap<String, String>> alAllOptions = (ArrayList<HashMap<String, String>>) remote.execute("com.kgm.service.VariantService",
...
//					System.out.println(" compare specOptionChangeInfo  " + specOptionChangeInfo);
	...
	private void set1LevelItemList(String product, String rowKey){
		...
		try {
			remote.execute("com.kgm.service.PartNameGroupService", "set1LevelItemList", ds);
