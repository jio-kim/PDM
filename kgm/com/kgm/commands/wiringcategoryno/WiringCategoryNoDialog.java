...
public class WiringCategoryNoDialog extends Dialog
{
	...
	protected void saveAction()
	{
		...
		if (r == 2)
		{
			...
			try
			{
				remoteQuery.execute("com.kgm.service.WiringCheckService", "deleteWiringCategoryNo", null);
			} catch (Exception e1)
			{
				e1.printStackTrace();
				MessageBox.post(shell, e1, true);
			...
			try
			{
				...
				remoteQuery.execute("com.kgm.service.WiringCheckService", "insertWiringCategoryNo", ds);
			} catch (Exception e)
			{
				e.printStackTrace();
	...
	protected void loadAction()
	{
		...
		try
		{
			resultList = (ArrayList<HashMap>) remoteQuery.execute("com.kgm.service.WiringCheckService", "getWiringCategoryNo", null);
		} catch (Exception e1)
		{
			e1.printStackTrace();
			MessageBox.post(shell, e1, true);
		...
		try
		{
			...
			final ArrayList<HashMap> rList = (ArrayList<HashMap>) remoteQuery.execute("com.kgm.service.WiringCheckService", "getWiringMailList", ds);
			Display.getDefault().syncExec(new Runnable()
			{
				@Override
				public void run()
