...
public class WiringMailListDialog extends Dialog
{
	...
	protected void loadAction()
	{
		...
		try
		{
			...
			ds.put("USER_ID", null);
			resultList = (ArrayList<HashMap>) remoteQuery.execute("com.kgm.service.WiringCheckService", "getWiringMailList", ds);
...
//					}
	...
	protected void saveAction()
	{
		...
		if (r == 2)
		{
			...
			try
			{
				remoteQuery.execute("com.kgm.service.WiringCheckService", "deleteWiringMailList", null);
			} catch (Exception e1)
			{
				e1.printStackTrace();
				MessageBox.post(shell, e1, true);
			...
			try
			{
				...
				remoteQuery.execute("com.kgm.service.WiringCheckService", "insertWiringMailList", ds);
			} catch (Exception e)
			{
				e.printStackTrace();
				MessageBox.post(shell, e, true);
	...
	private void getUserList()
	{
		...
		try
		{
			DataSet ds = new DataSet();
			ds.put("USER_ID", null);
			resultList = (ArrayList<HashMap>) remoteQuery.execute("com.kgm.service.WiringCheckService", "findUserInVNet", ds);
			if (resultList == null)
			{
				return;
			}
