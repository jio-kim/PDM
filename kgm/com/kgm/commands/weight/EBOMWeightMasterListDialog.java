 ...
 * @author   : 이정건
 * @since    : 2017. 7. 10.
 * Package ID : com.kgm.commands.weight.EBOMWeightMasterListDialog.java
 */
...
//								table.getModel().
	...
	public class ProductChangeOperation extends AbstractAIFOperation {
		...
		public void executeOperation() throws Exception {
			try {
				...
				try {
					variantList = (ArrayList<String>)remote.execute("com.kgm.service.MasterListService", "getVariantList", ds);
				} catch (Exception e) {
					throw e;
				}
				((DefaultListModel) comboVariant.getModel()).clear();
	...
	public TCComponentItemRevision getOSpecRevision(String product_id) throws Exception {
		...
		try {
			ospecNo = (String)remote.execute("com.kgm.service.MasterListService", "getOSINo", ds);
		} catch (Exception e) {
			throw e;
		}
...
//		return CustomUtil.findItemRevision("S7_OspecSetRevision", ospecId, "020");
	...
	public ArrayList<HashMap<String, String>> getEplData(String product_id, String variant_id, String function_id, String fmp_id) throws Exception {
		...
		ArrayList<HashMap<String, String>> result = (ArrayList<HashMap<String, String>>) remote.execute("com.kgm.service.MasterListService", "getEpl", ds);
		return result;
	}
	...
	public ArrayList<String> getChildren(String parent) throws Exception{
		...
		ArrayList<String> result = (ArrayList<String>) remote.execute("com.kgm.service.MasterListService", "getChildren", ds);
		return result;
	}
