		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			panel.setLayout(new BorderLayout(0, 0));
			{
				...
				try{
					...
					ArrayList<String> list = (ArrayList)remote.execute("com.kgm.service.VariantService", "getProjectCodes", ds);
					if( list != null ){
				...
				try {
					...
					result = (ArrayList)remote.execute("com.kgm.service.VariantService", "getLocalBuildSpecList", ds);
...
//						TC의 기존 Option Value를 삭제 하고, 새로 조회한 값을 입력한다.
							...
							AbstractAIFOperation operation = new AbstractAIFOperation() {
								...
								public void executeOperation() throws Exception {
									...
									try {
										ds.put("VARIANT_ID", BuildSpecImportDialog.this.target.getItem().getProperty("item_id"));
										result = (ArrayList)remote.execute("com.kgm.service.VariantService", "getBuildSpecList", ds);
					...
					searchBtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							try {
								...
								result = (ArrayList)remote.execute("com.kgm.service.VariantService", "getBuildSpecInfo", ds);
