...
public class CheckListDialog extends Dialog
{
	...
	{
		ArrayList<HashMap> resultList = (ArrayList<HashMap>) remoteUtil.execute("com.kgm.service.ECOAdminCheckService", "getCheckList", ds);
	...
	private void setLOVCombo(final Combo combo, String lovName, boolean isRemove)
	{
		...
		try
		{
			resultList = (ArrayList<HashMap>) remoteUtil.execute("com.kgm.service.ECOAdminCheckService", "getLOVData", ds);
		} catch (Exception e)
		{
			e.printStackTrace();
			MessageBox.post(shell, e, true);
	...
	private void setGroupCombo(final Combo combo)
	{
		...
		try
		{
			resultList = (ArrayList<HashMap>) remoteUtil.execute("com.kgm.service.ECOAdminCheckService", "getSYMCSubGroup", null);
		} catch (Exception e)
		{
			e.printStackTrace();
			MessageBox.post(shell, e, true);
