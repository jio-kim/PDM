...
public class TcDataManagementService extends DataManagementService {
	...
	public TraceabilityReportOutput1 getTraceReport(
			TraceabilityInfoInput1[] paramArrayOfTraceabilityInfoInput1)
	{
		return getService().getTraceReport(paramArrayOfTraceabilityInfoInput1);
	}

	@Override
	public ServiceData refreshObjects2(
			ModelObject[] paramArrayOfModelObject, boolean paramBoolean)
	{
		return getService().refreshObjects2(paramArrayOfModelObject, paramBoolean);
	}

	@Override
	public GetPasteRelationsResponse getPasteRelations(
			GetPasteRelationsInputData[] paramArrayOfGetPasteRelationsInputData)
	{
		return getService().getPasteRelations(paramArrayOfGetPasteRelationsInputData);
	}

	@Override
	public ReviseObjectsResponse reviseObjects(
			ReviseIn[] paramArrayOfReviseIn)
	{
		return getService().reviseObjects(paramArrayOfReviseIn);
	}

	@Override
	public ValidateValuesResponse validateValues(
			ValidateInput[] paramArrayOfValidateInput)
	{
		return getService().validateValues(paramArrayOfValidateInput);
	}

	@Override
	public GetChildrenResponse getChildren(
			GetChildrenInputData[] paramArrayOfGetChildrenInputData)
	{
		return getService().getChildren(paramArrayOfGetChildrenInputData);
	}

	@Override
	public SubTypeNamesResponse getSubTypeNames(
			SubTypeNamesInput[] paramArrayOfSubTypeNamesInput)
	{
		return getService().getSubTypeNames(paramArrayOfSubTypeNamesInput);
	}

	@Override
	public GenerateNextValuesResponse generateNextValues(
			GenerateNextValuesIn[] paramArrayOfGenerateNextValuesIn)
	{
		return getService().generateNextValues(paramArrayOfGenerateNextValuesIn);
	}

	@Override
	public ServiceData addChildren(
			ChildrenInputData[] paramArrayOfChildrenInputData)
	{
		return getService().addChildren(paramArrayOfChildrenInputData);
	}

	@Override
	public ServiceData removeChildren(
			ChildrenInputData[] paramArrayOfChildrenInputData)
	{
		return getService().removeChildren(paramArrayOfChildrenInputData);
	}
	...
	public TraceabilityReportOutput2 getTraceReport2(
			TraceabilityInfoInput1[] paramArrayOfTraceabilityInfoInput1)
	{
		return getService().getTraceReport2(paramArrayOfTraceabilityInfoInput1);
	}

	public TraceabilityReportOutputLegacy getTraceReportLegacy(
			TraceabilityInfoInput paramTraceabilityInfoInput)
	{
		return getService().getTraceReportLegacy(paramTraceabilityInfoInput);
	}

	@Override
	public AddParticipantOutput addParticipants(AddParticipantInfo[] arg0) {
		return getService().addParticipants(arg0);
	}

	@Override
	public CreateResponse bulkCreateObjects(BulkCreIn[] arg0) {
		return getService().bulkCreateObjects(arg0);
	}
    ...
    public DataManagementService getService() {
		return DataManagementService.getService(Session.getConnection());
	}
