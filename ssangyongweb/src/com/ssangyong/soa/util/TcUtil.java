...
public class TcUtil {
    ...
    public ModelObject[] filterTypeModelObject(ModelObject[] modelComp, String filterType) throws Exception {
        ...
        tcServiceManager.getDataService().getProperties(modelComp, new String[]{TcConstants.PROP_OBJECT_TYPE});
        int idx=0;
...
//        }
     ...
     * @return String
     * @Comment
     * TYPE_DATASET_EXCEL_2007 Ãß°¡ : 2014.01.02 hybyeon
     */
    ...
    public static HashMap<String, String> makeMessageOfFail(ServiceData serviceData) {
        ...
        ldata.put(TcConstants.TC_RETURN_MESSAGE, TcConstants.TC_RETURN_FAIL);
        ldata.put(TcConstants.TC_RETURN_FAIL_REASON, sb.toString());
     ...
     * @Comment
     */
    public static HashMap<String, String> makeMessageOfFail(ArrayList<ServiceData> servicelist) {
        StringBuffer sb = new StringBuffer();
     ...
     * @Comment
     */
    public static HashMap<String, String> returnMessageOfFail(String message) {

        HashMap<String, String> ldata = new HashMap<String, String>();
        ldata.put(TcConstants.TC_RETURN_MESSAGE, TcConstants.TC_RETURN_FAIL);
        ldata.put(TcConstants.TC_RETURN_FAIL_REASON, message);
     ...
     * @Comment
     */
    public static HashMap<String, String> makeMessageOfSucess() {
        HashMap<String, String> ldata = new HashMap<String, String>();
        ldata.put(TcConstants.TC_RETURN_MESSAGE, TcConstants.TC_RETURN_OK);
    ...
    public boolean compareUserOfModel(String uid) throws Exception {
        ...
        tcServiceManager.getDataService().getProperties(new ModelObject[] {modelComp}, new String[] { TcConstants.PROP_OWNING_USER });
        TcSessionUtil tcSessionUtil = new TcSessionUtil(tcSession);
        ModelObject[] users = new ModelObject[2];
        users[0] = (User)modelComp.getPropertyObject(TcConstants.PROP_OWNING_USER).getModelObjectValue();
        users[1] = tcSessionUtil.getUser();
        tcServiceManager.getDataService().getProperties(users, new String[] { TcConstants.PROP_USER_ID });
