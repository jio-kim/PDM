...
import com.ssangyong.mapper.CCNInfoMapper;
...
public class CCNInfoDao extends AbstractDao {
	...
	public Object getDwgDeployableDate(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			Object obj = session.selectOne("com.ssangyong.mapper.CCNInfoMapper.selectDwgDeployableDate", ds);
	...
	public Object getDcsReleasedDate(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			Object obj = session.selectOne("com.ssangyong.mapper.CCNInfoMapper.selectDcsReleasedDate", ds);
	...
	public ArrayList<String> whereUsed(DataSet dataSet) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList<?> list = (ArrayList<?>)session.selectList("com.ssangyong.mapper.CCNInfoMapper.whereUsed", dataSet);
	...
	public String getParent4Digit(DataSet dataSet) throws Exception{
		try{
			SqlSession session = getSqlSession();
			String str = session.selectOne("com.ssangyong.mapper.CCNInfoMapper.getParent4Digit", dataSet);
	...
	public String getParent4DigitReleased(DataSet dataSet) throws Exception{
		try{
			SqlSession session = getSqlSession();
			String str = session.selectOne("com.ssangyong.mapper.CCNInfoMapper.getParent4DigitReleased", dataSet);
	...
	public String getPreRevisionPuid(DataSet dataSet) throws Exception{
		try{
			SqlSession session = getSqlSession();
			String str = session.selectOne("com.ssangyong.mapper.CCNInfoMapper.getPreRevisionPuid", dataSet);
