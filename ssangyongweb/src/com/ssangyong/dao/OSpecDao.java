...
public class OSpecDao extends AbstractDao {
	...
	public void insertOSpec(DataSet ds) throws Exception{
        ...
        try {
            ...
            HashMap tmpMap = session.selectOne("com.ssangyong.mapper.ospec.getOspecMaster", oSpecMaster);
            if(tmpMap!=null && !tmpMap.isEmpty()){
            	session.delete("com.ssangyong.mapper.ospec.deleteOspecDetail", oSpecMaster);
            }
            
            ArrayList tmpList = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOspecTrim", oSpecMaster);
            if(tmpList!=null && !tmpList.isEmpty()){
            	session.delete("com.ssangyong.mapper.ospec.deleteOspecTrim", oSpecMaster);
            }            
        	...
        	for( HashMap<String, String> trim : trimList){
        		session.insert("com.ssangyong.mapper.ospec.insertOspecTrim", trim);
        	}
            
            session.insert("com.ssangyong.mapper.ospec.insertOspecMaster", oSpecMaster);
            for( HashMap<String, String> map : data){
            	session.insert("com.ssangyong.mapper.ospec.insertOspecDetail", map);
            }
            session.commit();
        } catch (Exception e) {
        	session.rollback();
	...
	public ArrayList getOspecMaster(DataSet ds) throws Exception{
		try{
			...
			ArrayList masterInfo = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOspecMaster", ds);
	...
	public ArrayList getOspecDetail(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList ospecDetail = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOspecDetail", ds);
	...
	public HashMap getOspec(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList ospecMaster = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOspecMaster", ds);
			ArrayList ospecTrim = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOspecTrim", ds);
			ArrayList ospecDetail = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOspecDetail", ds);
	...
	public ArrayList getGModel(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList gModels = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getGModel", ds);
	...
	public ArrayList getProject(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList projects = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getProject", ds);
	...
	public ArrayList getOptionGroup(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList optionGroup = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOptionGroup", ds);
	...
	public void insertOptionGroup(DataSet ds) throws Exception{
        ...
        try {
            ...
            for( int i = 0; data != null && i < data.size(); i++){
            	...
            	if( i == 0 ){
            		session.delete("com.ssangyong.mapper.ospec.deleteOptionGroup", map);
            	}
            	session.insert("com.ssangyong.mapper.ospec.insertOptionGroup", map);
            }
        } catch (Exception e) {
            e.printStackTrace();
	...
	public ArrayList getOptionGroupDetail(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList optionGroupDetail = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getOptionGroupDetail", ds);
	...
	public void deleteOptionGroup(DataSet ds) throws Exception{
        ...
        try {
            session = getSqlSession();
            session.delete("com.ssangyong.mapper.ospec.deleteOptionGroup", ds);
        } catch (Exception e) {
            e.printStackTrace();
		...
		try{
			...
			while(its.hasNext()){
				...
				for( String opValue : list){
					...
					ArrayList referredOptionGroup = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getReferedOptionGroup", map);
	...
	public ArrayList getFunctionList(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList functionList = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getFunctionList", ds);
	...
	public ArrayList getUsedCondition(DataSet ds) throws Exception{
		try{
			...
			for(int i = 0; functionList!=null && i < functionList.size(); i++){
				...
				ArrayList conditionList = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getUsedCondition", map);
    ...
    public void updateOSpecTrimStat(DataSet ds) throws Exception {
    	try{
			SqlSession session = getSqlSession();
			session.update("com.ssangyong.mapper.ospec.updateOSpecTrimStat", ds);
		}catch(Exception e){
			e.printStackTrace();
    ...
    public void updateOpGroupMaster(DataSet ds) throws Exception {
    	try{
			SqlSession session = getSqlSession();
			session.update("com.ssangyong.mapper.ospec.updateOpGroupMaster", ds);
		}catch(Exception e){
			e.printStackTrace();
    ...
    public void updateOpGroupCondition(DataSet ds) throws Exception {
    	try{
			SqlSession session = getSqlSession();
			session.update("com.ssangyong.mapper.ospec.updateOpGroupCondition", ds);
		}catch(Exception e){
			e.printStackTrace();
    ...
    public String getOpGroupCondition(DataSet ds) throws Exception {
    	try{
			SqlSession session = getSqlSession();
			return (String)session.selectOne("com.ssangyong.mapper.ospec.getOpGroupCondition", ds);
		}catch(Exception e){
			e.printStackTrace();
    ...
    public ArrayList getDCSInfo(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList list = (ArrayList)session.selectList("com.ssangyong.mapper.ospec.getDCSInfo", ds);
