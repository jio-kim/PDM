...
public class MasterListDao extends AbstractDao {
	...
	public ArrayList getWorkingCCN(DataSet ds) throws Exception{
		try{
			...
			ArrayList workingCCNs = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.selectWorkingCCN", ds);
	...
	public ArrayList getPart(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList parts = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.selectPart", ds);
	...
	public ArrayList getStoredOptionSet(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList optionSet = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.selectStoredOptionSet", ds);
	...
	public ArrayList getEssentialName(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList list = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.selectEssentialName", ds);
	...
	public Object getSysGuid(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			Object obj = session.selectOne("com.ssangyong.mapper.masterlist.selectSysGuid", ds);
	...
	public Object getDwgDeployableDate(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			Object obj = session.selectOne("com.ssangyong.mapper.masterlist.selectDwgDeployableDate", ds);
	...
	public Object getBVRModifyDate(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			Object obj = session.selectOne("com.ssangyong.mapper.masterlist.selectBVRModifyDate", ds);
	...
	public Object getExistPart(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			Object obj = session.selectOne("com.ssangyong.mapper.masterlist.selectExistPart", ds);
	...
	public HashMap<String, String> getLatestWMLMTargetData(DataSet ds) throws Exception {
		...
		try{            
			SqlSession session = getSqlSession();
			result = session.selectOne("com.ssangyong.mapper.masterlist.getLatestWMLMTargetData", ds);
		}catch(Exception e){
			throw e;
		}finally{
			sqlSessionClose();
	...
	public List<HashMap<String, Object>> getWeightMasterDataList(DataSet ds) throws Exception {
		...
		try{            
			SqlSession session = getSqlSession();
			result = session.selectList("com.ssangyong.mapper.masterlist.getWeightMasterDataList", ds);
		}catch(Exception e){
			throw e;
		}finally{
			sqlSessionClose();
	...
	public List<HashMap<String, Object>> getBOMLineTrimList(DataSet ds) throws Exception {
		...
		try{            
			SqlSession session = getSqlSession();
			result = session.selectList("com.ssangyong.mapper.masterlist.getBOMLineTrimList", ds);
		}catch(Exception e){
			throw e;
		}finally{
			sqlSessionClose();
	...
	public List<Map<String, Object>> getMLMLoadProp(DataSet ds) throws Exception {
		...
		try{            
			SqlSession session = getSqlSession();
			result = session.selectList("com.ssangyong.mapper.masterlist.getMLMLoadProp", ds);
		}catch(Exception e){
			throw e;
		}finally{
			sqlSessionClose();
	...
	public ArrayList getVariantList(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList varialtList = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.getVariantList", ds);
	...
	public String getOSINo(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			String osi_no = (String)session.selectOne("com.ssangyong.mapper.masterlist.getOSINo", ds);
	...
	public ArrayList getEpl(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList epl = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.getEpl", ds);
	...
	public ArrayList<String> getChildren(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList epl = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.getChildren", ds);
	...
	public ArrayList<String> getAllChildren(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList epl = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.getAllChildren", ds);
	...
	public ArrayList<String> getAllChildrenReleased(DataSet ds) throws Exception{
		try{
			SqlSession session = getSqlSession();
			ArrayList epl = (ArrayList)session.selectList("com.ssangyong.mapper.masterlist.getAllChildrenReleased", ds);
