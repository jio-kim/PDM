...
import com.ssangyong.mapper.VariantMapper;
...
//			map = (HashMap)session.selectOne("com.ssangyong.mapper.VariantMapper.getItem", ds);
		}catch(Exception e){
			e.printStackTrace();
...
//			result = session.insert("com.ssangyong.mapper.VariantMapper.insertVariantValueDesc", ds);
	...
	public int updateVariantValueDesc(DataSet ds) throws Exception{
		...
		try{
			...
			SqlSession session = getSqlSession();
//			result = session.update("com.ssangyong.mapper.VariantMapper.updateVariantValueDesc", ds);
			VariantMapper mapper = session.getMapper(VariantMapper.class);
...
//			result = session.selectList("com.ssangyong.mapper.VariantMapper.getVariantValueDesc", ds);
