...
import com.symc.common.soa.util.TcMessage;
...
//          }
            ...
            ldata.put(TcConstants.TC_RETURN_FAIL_REASON, TcMessage.MSG_REQUIRED_PARAM);
        }
        return ldata;
    }
    ...
    public HashMap<String,Object> performAction(String revOuid) throws Exception {
        ...
        for(ModelObject obj : stageList) {
            ...
            if(obj instanceof EPMTask) {
                ...
                tcServiceManager.getDataService().getProperties(new ModelObject[] {task}, new String[] {TcConstants.PROP_OBJECT_TYPE});
