...
public class TcQueryService {
    ...
    public ItemRevision[] getAllECOItem() throws Exception {
        ...
        String[] revisionProperties = {TcConstants.PROP_ITEM_ID, "s7_ECO_REGULATION", "s7_CHANGE_REASON", "s7_EFFECT_POINT", "s7_ECO_TYPE", "s7_DESIGN_CONCEPT_NO", "s7_DESIGN_REG_CATG", "s7_ADR_YN", "s7_CANADA_YN", "s7_CHINA_YN", "s7_JAPAN_YN", "s7_DOM_YN", "s7_ECC_YN", "s7_ECE_YN", "s7_GCC_YN", "s7_FMVSS_YN", "s7_OTHERS_YN", "s7_DR_ITEM_YN", "s7_ENV_LAW_YN", "s7_ENV_LAW_DESC", "s7_WEIGHT_CHG_YN", "s7_COST_CHG_YN", "s7_MATERIAL_CHG_YN", "s7_RECYCLING_YN", "s7_SE_YN", "s7_DESIGN_VERIFY", "s7_VEH_DVP_YN", "s7_VEH_DVP_RESULT_YN", "s7_VEH_DVP_RESULT_DESC", "s7_DESIGN_CATG_DESC", "s7_SE_RELATED_DOC", "s7_ECR_NO", "s7_REPRESENTED_PROJECT", "s7_AFFECTED_PROJECT", "s7_ECO_MATURITY", "s7_EFFECT_POINT_DATE", "s7_ECO_KIND", "s7_IF_STAT"};
        String queryName = TcConstants.SEARCH_GENERAL;
        String[] entries = { "Type" };
        String[] values = { "S7_ECO" };
        SavedQueriesResponse executeSavedQueries = tcServiceManager.getQueryService().executeSavedQueries(tcQueryUtil.setQueryInputforSingle(queryName, entries, values, "site"));
        if (!tcServiceManager.getDataService().ServiceDataError(executeSavedQueries.serviceData)) {
            ...
            tcItemUtil.getProperties(items, new String[] { TcConstants.PROP_ITEM_ID, "revision_list"  });
