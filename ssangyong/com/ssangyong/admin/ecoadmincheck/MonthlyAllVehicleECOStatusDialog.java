	...
	protected void search(DataSet ds) throws Exception
	{
		...
		try
		{
			...
			if(reportType.equals("ECO")){
				resultList = (ArrayList<HashMap>) remoteQuery.execute("com.ssangyong.service.ECOAdminCheckService", "getMonthlyAllVehicleECOStatus", ds);	
			}else{
				resultList = (ArrayList<HashMap>) remoteQuery.execute("com.ssangyong.service.ECOAdminCheckService", "getMonthlyAllVehicleEndItemStatus", ds);
			}
