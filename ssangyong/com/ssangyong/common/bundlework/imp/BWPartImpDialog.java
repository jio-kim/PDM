...
public class BWPartImpDialog extends BWXLSImpDialog {
    ...
    private void loadData() {
        ...
        try {
            ...
            rows = (ArrayList<HashMap>) remote.execute("com.ssangyong.service.MigrationService", "getItemValidationList", ds);
    ...
    */
    ...
    {        
        ...
        try {
            ...
            remote.execute("com.ssangyong.service.MigrationService", "updateMigrationStatusChange", ds);
        } catch (ConnectException ce) {
            ce.printStackTrace();
            // throw new
            // MigrationException("Migration Data DB connect Error occurred!");
