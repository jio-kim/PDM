...
import static com.ssangyong.common.bundlework.BundleWorkDialog.STATUS_COMPLETED;
import static com.ssangyong.common.bundlework.BundleWorkDialog.STATUS_ERROR;
import static com.ssangyong.common.bundlework.BundleWorkDialog.STATUS_INPROGRESS;
...
public class BWVariantOptionImpDialog extends BWXLSImpDialog {
	...
	private void excelLoad(File file) throws Exception{
    	...
    	Registry customRegistry = Registry.getRegistry("com.ssangyong.common.bundlework.imp.imp");
...
//        	target.window().refresh();
	...
	private void insertOsiInfo() throws Exception{
		if( !osiSpec.isEmpty()){
			...
			// com.ssangyong.serv1ice.VariantService --> com.ssangyong.service.VariantService
			remote.execute("com.ssangyong.service.VariantService", "insertOsiInfo", ds);
		}
	}
	...
	private void insertOSpecTrim(OSpec ospec) throws Exception {
		...
		ArrayList<HashMap<String, String>> result = (ArrayList<HashMap<String, String>>)remote.execute("com.ssangyong.service.VariantService", "selectOSpecTrim", dsTemp);
		
		if (result.size() > 0) {
			boolean isDelete = (Boolean) remote.execute("com.ssangyong.service.VariantService", "deleteOSpecTrim", dsTemp);
		...
		for (int inx = 0; inx < alTrims.size(); inx++) {
			...
			remote.execute("com.ssangyong.service.VariantService", "insertOSpecTrim", ds);
		}
	}
