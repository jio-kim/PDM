...
import com.ssangyong.common.ui.GlassPaneForReq;
...
//	private VariantOption option = null;
	...
	private void init(){
		...
		try {
			...
			usedOptionList = (List)remote.execute("com.ssangyong.service.VariantService", "getUsedOptions", ds);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	...
	private void editOption(){
		...
		if( option.hasValues()){
			...
			try {
				...
				result = (Integer)remote.execute("com.ssangyong.service.VariantService", "getUsedCount", ds);
			} catch (Exception e) {
