 ...
 * @author   : 이정건
 * @since    : 2017. 7. 10.
 * Package ID : com.ssangyong.commands.weight.PropertyConstant.java
 */
public class PropertyConstant {
	...
	public static final String ATTR_NAME_PROTOTOOLING = "s7_IS_PTOTO_TOOLING"; //[SR170703-020][LJG]Proto Tooling 컬럼 추가
...
//	public static final String ATTR_NAME_ENG_RESPONSIBLITY = "s7_ENG_RESPONSIBLITY"; // 설계 담당 담당
	...
	public static final String ATTR_NAME_BL_LEV = "bl_level";
