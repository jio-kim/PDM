...
//		setBounds(100, 100, 578, 524);
							...
							validationBtn.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent event) {
									...
									//Spec ComboBox에서 사용자가 선택한 스펙들
										...
										ArrayList<HashMap> specOptionlist = (ArrayList<HashMap>)remote.execute("com.ssangyong.service.VariantService", "getSpecOptions", ds);
										...
										for( String specPuid : sosList){
											...
											HashMap<String, Object> minusInfoMap= (HashMap)remote.execute("com.ssangyong.service.VariantService", "getMinusInfo", ds);
										...
										ds.clear();
										ds.put("FUNCTION_MASTERS", funcMasterList);
										ArrayList<HashMap<String, Object>> validationInfoList= (ArrayList)remote.execute("com.ssangyong.service.VariantService", "getValidationInfoList", ds);
							...
							addBtn.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									try{
										...
										remote.execute("com.ssangyong.service.VariantService", "insertValidationInfo", ds);
							...
							delBtn.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									try{
										DataSet ds = new DataSet();
										ds.put("IDX", idx);
										remote.execute("com.ssangyong.service.VariantService", "deleteValidationInfo", ds);
	...
	private void getEditAllData(){
		...
		try {
			...
			ds.put("FUNCTION_MASTERS", funcMasterList);
			ArrayList<HashMap<String, Object>> list= (ArrayList)remote.execute("com.ssangyong.service.VariantService", "getValidationInfoList", ds);
