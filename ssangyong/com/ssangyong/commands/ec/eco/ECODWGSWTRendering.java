...
public class ECODWGSWTRendering extends AbstractSYMCViewer implements IPageComplete {
    ...
    private void setTableData() throws Exception {
        ...
        final ArrayList<SYMCECODwgData> data = (ArrayList<SYMCECODwgData>) remote.execute("com.ssangyong.service.ECOHistoryService", "selectECODwgList", ds);
        // Modify List Clear
            ...
            composite.getDisplay().syncExec(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Boolean updateStatus = (Boolean) remote.execute("com.ssangyong.service.ECOHistoryService", "updateECODwgProperties", ds);
