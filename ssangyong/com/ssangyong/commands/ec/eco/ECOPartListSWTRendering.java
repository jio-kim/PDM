...
public class ECOPartListSWTRendering extends AbstractSYMCViewer {
    ...
    private void setTableData() throws Exception {
        ...
        final ArrayList<SYMCPartListData> data = (ArrayList<SYMCPartListData>) remote.execute("com.ssangyong.service.ECOHistoryService", "selectECOPartList", ds);
        getDisplay().syncExec(new Runnable() {
            public void run() {
            ...
            main.getDisplay().syncExec(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Boolean updateStatus = (Boolean) remote.execute("com.ssangyong.service.ECOHistoryService", "updateECOPartListProperties", ds);
