...
//		ArrayList<SYMCECODwgData> resultList = dao.selectECODwgList(propertyMap.get("item_id"));
		...
		ArrayList<SYMCECODwgData> resultList = (ArrayList<SYMCECODwgData>) remote.execute("com.ssangyong.service.ECOHistoryService", "selectECODwgList", ds);
...
//		ArrayList<SYMCBOMEditData> resultList = dao.selectECOEplList(propertyMap.get("item_id"));
        ...
        DataSet ds = new DataSet();
        ds.put("ecoNo", propertyMap.get("item_id"));
        ArrayList<SYMCBOMEditData> resultList = (ArrayList<SYMCBOMEditData>) remote.execute("com.ssangyong.service.ECOHistoryService", "selectECOEplList", ds);
...
//		ArrayList<SYMCBOMEditData> resultList = dao.selectECOEplList(propertyMap.get("item_id"));
        ...
        DataSet ds = new DataSet();
        ds.put("ecoNo", propertyMap.get("item_id"));
        ArrayList<SYMCPartListData> resultList = (ArrayList<SYMCPartListData>) remote.execute("com.ssangyong.service.ECOHistoryService", "selectECOPartList", ds);
