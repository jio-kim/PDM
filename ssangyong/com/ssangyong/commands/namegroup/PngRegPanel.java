...
//						conditionModel.addRow(row);
	...
	private void insertPngGroup(PngMaster pngGroup) throws Exception{
		...
		try {
			...
			remote.execute("com.ssangyong.service.PartNameGroupService", "insertPngMaster", ds);
...
//	    }
	...
	private void deleteNameGroup(String groupID) throws Exception{
		...
		try {
			...
			remote.execute("com.ssangyong.service.PartNameGroupService", "deletePngMaster", ds);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			throw e;
		}			
