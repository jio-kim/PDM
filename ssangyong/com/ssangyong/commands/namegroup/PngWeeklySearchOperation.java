...
public class PngWeeklySearchOperation extends AbstractAIFOperation implements InterfaceAIFOperationListener {
	...
	private ArrayList<HashMap<String, Object>> retrieveResultList() throws Exception {
		...
		ArrayList<HashMap<String, Object>> resultList = (ArrayList<HashMap<String, Object>>) remote.execute("com.ssangyong.service.PartNameGroupService", "getPngWeeklyErrorReport", ds);
		return resultList;
	}
...
//			System.out.println(spec_no);
	...
	private String getModelYear(String spec_no) throws Exception {
		...
		ArrayList<String> resultList = (ArrayList<String>) remote.execute("com.ssangyong.service.PartNameGroupService", "getModelYear", ds);
