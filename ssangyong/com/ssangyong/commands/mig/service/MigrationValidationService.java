package com.ssangyong.commands.mig.service;

import java.net.ConnectException;
import java.util.ArrayList;
import java.util.HashMap;

import com.ssangyong.commands.mig.MigrationDialog;
import com.ssangyong.commands.mig.exception.MigrationException;
...
public class MigrationValidationService {    
    ...
    public void validation(String objectType, String batchType, String seqType) throws MigrationException {
        ...
        try {
            ...
            this.validationList = (ArrayList<HashMap>) remote.execute("com.ssangyong.service.MigrationService", "getValidationList", ds);
    ...
    private void updateMigrationStatus() {
        ...
        try {
            ...
            ds.put("objectType", objectType);
            remote.execute("com.ssangyong.service.MigrationService", "updateMigrationStatus", ds);
        } catch (ConnectException ce) {
            ce.printStackTrace();
            // throw new
