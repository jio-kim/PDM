...
public class BWPreFunctionImpDialog extends BWXLSImpDialog {
     ...
     * @param cls
     */
    public BWPreFunctionImpDialog(Shell parent, int style, Class<?> cls) {
     ...
     * @param style
     */
    public BWPreFunctionImpDialog(Shell parent, int style) {
        
        super(parent, style, BWPreFunctionImpDialog.class); 
        try {
    ...
    public void validatePost() throws Exception {
        ...
        PreFncPartValidator validator = new PreFncPartValidator(szLovNames);
        ...
        for (int i = 0; i < szTopItems.length; i++) {
            ...
            this.validationPreFunctionPart(topTreeItem, validator);
        }
    ...
    private void validationPreFunctionPart(ManualTreeItem treeItem, PreFncPartValidator validator) {
