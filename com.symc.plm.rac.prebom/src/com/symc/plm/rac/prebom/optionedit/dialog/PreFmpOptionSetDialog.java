...
import com.ssangyong.commands.optiondefine.VariantOptionDefinitionDialog;
import com.ssangyong.commands.variantoptioneditor.tree.VariantNode;
import com.ssangyong.common.WaitProgressBar;
import com.ssangyong.common.utils.variant.VariantCheckBoxTableCellEditor;
import com.ssangyong.common.utils.variant.VariantCheckBoxTableCellRenderer;
...
//	private ArrayList<VariantOption> globalOptionSet;	//Corporate Option 정보를 가지고 있는 Set
	...
	private Vector<String[]> userDefineErrorList = new Vector();	//사용자 정의 에러 리스트
	private Vector<String[]> moduleConstraintList = new Vector();	//모듈 구속 조건 리스트
