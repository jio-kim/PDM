...
public class BOMHelpBrowserComposite extends AbstractWelcomeComposite {
    private static Registry registry = Registry.getRegistry(BrowserComposite.class);
    private static Registry registry_custom = Registry.getRegistry(BOMHelpBrowserComposite.class);
    private static String m_defaultHomeUrl = registry_custom.getString("BrowserView.homeUrl");
    private String m_homeUrl;
    private Browser browser;

    public BOMHelpBrowserComposite(Composite paramComposite) {
        this(paramComposite, null);
    }

    public BOMHelpBrowserComposite(Composite paramComposite, String paramString) {
    ...
    public void initialize(Composite paramComposite) {
        ...
        localToolItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent paramSelectionEvent) {
                BOMHelpBrowserComposite.this.browser.setUrl(BOMHelpBrowserComposite.this.m_homeUrl);
            }
        });
        ...
        localToolItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent paramSelectionEvent) {
                BOMHelpBrowserComposite.this.browser.back();
            }
        });
        localToolItem = new ToolItem(localToolBar, 0);
        ...
        localToolItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent paramSelectionEvent) {
                BOMHelpBrowserComposite.this.browser.forward();
            }
        });
        localToolItem = new ToolItem(localToolBar, 0);
        ...
        localToolItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent paramSelectionEvent) {
                BOMHelpBrowserComposite.this.browser.refresh();
            }
        });
        localToolItem = new ToolItem(localToolBar, 0);
        ...
        localToolItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent paramSelectionEvent) {
                BOMHelpBrowserComposite.this.browser.stop();
            }
        });
        localToolItem = new ToolItem(localToolBar, 0);
        ...
        localToolItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent paramSelectionEvent) {
                ...
                BOMHelpBrowserComposite.this.browser.execute(str);
            }
        });
    ...
    private String getHomeUrlPreference() {
        ...
        // String str = localIPreferenceService.getString(0, "BOMHelp_Browser_Home_URL", m_defaultHomeUrl);
        String str = localIPreferenceService.getStringValue("BOMHelp_Browser_Home_URL");
        if (str == null) {
