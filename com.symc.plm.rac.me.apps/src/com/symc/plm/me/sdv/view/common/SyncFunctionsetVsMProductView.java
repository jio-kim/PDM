...
/**
 * Class Name : SyncFunctionsetVsBOMView
 ...
 * 
 */
public class SyncFunctionsetVsMProductView extends AbstractSDVViewPane {
     ...
     * @param id
     */
    public SyncFunctionsetVsMProductView(Composite parent, int style, String id) {
    ...
    public class InitOperation extends AbstractSDVInitOperation {
        ...
        public void executeOperation() throws Exception {
            ...
            viewDataSet.addDataMap(SyncFunctionsetVsMProductView.this.getId(), displayDataMap);
            setData(viewDataSet);
        }
    }
