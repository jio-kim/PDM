 ...
 * 
 */
public class PaintShopView extends AbstractSDVViewPane {
    ...
    public PaintShopView(Composite parent, int style, String id) {
    ...
    protected void initUI(Composite parent) {
        ...
        lovShop = new SDVLOVComboBox(compositeInform, SWT.BORDER, tcSession, "M7_BOPP_SHOP_CODE");
    ...
    public class InitOperation extends AbstractSDVInitOperation {
        ...
        public void executeOperation() throws Exception {
            ...
            try {
                ...
                viewDataSet.addDataMap(PaintShopView.this.getId(), displayDataMap);
                setData(viewDataSet);
