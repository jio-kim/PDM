...
/**
 * Class Name : CreateEquipmentItemService
 * Class Description :
 * 
 * @date 2013. 12. 16.
 * 
 */
public class CreateEquipmentItemService extends AbstractResourceCreaeItemService {

    /**
     * @param datamap
     * @throws Exception
     */
    public CreateEquipmentItemService(IDataMap datamap) throws Exception {
        super(datamap);
    }
