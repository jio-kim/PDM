...
public class SelectedPlantLineSDVValidator implements ISDVValidator {

    private Registry registry = Registry.getRegistry(SelectedPlantLineSDVValidator.class);

    public SelectedPlantLineSDVValidator() {
    }
    ...
    public void validate(String commandId, Map<String, Object> parameter, Object applicationCtx) throws SDVException {
        ...
        try {
            ...
            if (itemRevision != null) {
                ...
                // 선택한 targetItem이 Line이면 오류 처리
                if (itemRevisionType.equals(SDVTypeConstant.PLANT_LINE_ITEM_REVISION)) {
                    throw new ValidateSDVException(registry.getString("SelectedPlantLine.Line.MESSAGE"));
                }
            }
        } catch (Exception ex) {
