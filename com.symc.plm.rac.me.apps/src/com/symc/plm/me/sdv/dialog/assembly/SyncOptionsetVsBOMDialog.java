 ...
 * 
 */
public class SyncOptionsetVsBOMDialog extends SimpleSDVDialog {
     ...
     * @param dialogStub
     */
    public SyncOptionsetVsBOMDialog(Shell shell, DialogStubBean dialogStub) {
