...
/**
 * Class Name : CreateAssemblyLineDialog
 * Class Description :
 * 
 * @date 2013. 11. 15.
 * 
 */
public class CreateAssemblyLineDialog extends SimpleSDVDialog {
    // ActionButton
     ...
     * @param dialogStub
     */
    public CreateAssemblyLineDialog(Shell shell, DialogStubBean dialogStub) {
    ...
    protected boolean validationCheck() {
         ...
         * 중복된 Item Id 체크 유무
         */
        String itemId = PLANT_PREFIX + txtShopCode + "-" + lovLine + "-" + txtProductCode + "-00";
        try {
