 ...
 * 
 */
public class SaveAsPaintOPDialog extends SimpleSDVDialog {
     ...
     * @param dialogStub
     */
    public SaveAsPaintOPDialog(Shell shell, DialogStubBean dialogStub) {
    ...
    protected boolean validationCheck() {
        ...
        try {
            TCComponentItem item = SDVBOPUtilities.FindItem(itemId, SDVTypeConstant.BOP_PROCESS_PAINT_OPERATION_ITEM);
            if (item != null) {
