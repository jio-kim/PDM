 ...
 * 
 * Class Name : CreateAssemblyLineOperation
 * Class Description :
 * 
 * @date 2013. 11. 27.
 * 
 */
public class CreateAssemblyLineOperation extends AbstractSDVActionOperation {
     ...
     * @param dataSet
     */
    public CreateAssemblyLineOperation(int actionId, String ownerId, IDataSet dataSet) {
        super(actionId, ownerId, dataSet);
    }

    public CreateAssemblyLineOperation(String actionId, String ownerId, Map<String, Object> parameters, IDataSet dataset) {
    ...
    public void executeOperation() throws Exception {
        ...
        // Item Id 조합
        String itemId = "PTP" + "-" + shopCode + "-" + Line + "-" + productCode + "-00";
    ...
    private void setProperties() throws TCException {
        ...
        // Process Type 조립
        createdItemRevision.setProperty(SDVPropertyConstant.LINE_REV_PROCESS_TYPE, "A");
