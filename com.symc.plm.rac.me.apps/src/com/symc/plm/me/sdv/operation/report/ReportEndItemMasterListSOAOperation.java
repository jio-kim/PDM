...
public class ReportEndItemMasterListSOAOperation extends AbstractTCSDVOperation {
	...
	public ReportEndItemMasterListSOAOperation() {
	}
	...
	public void startOperation(String commandId) {
		...
		System.out.println("ReportEndItemMasterListSOAOperation : startOperation");
	...
	public void executeOperation() throws Exception {
		...
		System.out.println("ReportEndItemMasterListSOAOperation : executeOperation");
		
		if(mode != 1){
			System.out.println("ReportEndItemMasterListSOAOperation : Cancle()");
...
//        System.out.println("ccObject : "+ccObject.toString());
		...
		ds.put("typeOfReport", "End Item Master List Report");
...
//			MessageBox.post(AIFUtility.getActiveDesktop().getShell(), messageStr, "Succeed", MessageBox.INFORMATION);		            
	...
	public void endOperation() {
		...
		System.out.println("ReportEndItemMasterListSOAOperation : endOperation");
