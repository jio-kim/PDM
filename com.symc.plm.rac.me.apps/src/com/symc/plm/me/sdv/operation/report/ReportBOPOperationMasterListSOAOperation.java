...
/**
 * Class 설명 :  MPP 상에서 Report 메뉴의 사이트 메뉴중 Operation Master List(On Server) 클릭시 동작 
 * 				
 * 
 * 
 * @author 178650
 *
 */
public class ReportBOPOperationMasterListSOAOperation extends AbstractTCSDVOperation {
	 ...
	 * 			  실행시 "작업정보" 추가로 인해   "selectedValue"  변수 추가
	 */
	protected IDataMap localDataMap0;
	//////////////////////////////////////////////////////////////////////////
    
	public ReportBOPOperationMasterListSOAOperation() {
	}
	...
	public void startOperation(String commandId) {
		...
		System.out.println("OperationMasterListSOAOperation : startOperation");
            ...
            public void run() {
                ...
                try {
                    ...
                    // OK 버튼을 누른 경우
						...
						* 			  실행시 "작업정보" 추가로 인해   "selectedValue"  변수 추가
						*/
                        	IViewPane soaReportMessageView =  dialog.getView("soaReportMessageView");
                        	localDataMap0 = ((SOAReportMessageView)soaReportMessageView).getLocalDataMap0();
                        /////////////////////////////////////////////////////////////////////////////
                    }
                } catch(Exception e) {
                    returnValue = -1;
	...
	public void executeOperation() throws Exception {
		...
		System.out.println("OperationMasterListSOAOperation : executeOperation");
		
		if(mode != 1){
			System.out.println("OperationMasterListSOAOperation : Cancle()");
        ...
        // [20240419][UPGRADE] MECollaborationContext 가 없는 경우 이후 로직을 실행하지 않도록 추가 
//        System.out.println("ccObject : "+ccObject.toString());
		...
		ds.put("typeOfReport", "Operation Master List Report");
...
//			MessageBox.post(AIFUtility.getActiveDesktop().getShell(), messageStr, "Succeed", MessageBox.INFORMATION);		            
	...
	public void endOperation() {
		...
		System.out.println("OperationMasterListSOAOperation : endOperation");
