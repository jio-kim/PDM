 ...
 * 
 */
public class SaveAsPaintOPDialogOperation extends SimpleTCSDVDialogOperation {
    private static final Logger logger = Logger.getLogger(SaveAsPaintOPDialogOperation.class);
...
//            }
            ...
            isEnableType = selectedItemType.equals(SDVTypeConstant.BOP_PROCESS_PAINT_OPERATION_ITEM);
            if (!isEnableType) {
