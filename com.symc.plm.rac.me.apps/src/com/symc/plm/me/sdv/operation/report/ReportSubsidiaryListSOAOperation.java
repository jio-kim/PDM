...
public class ReportSubsidiaryListSOAOperation extends AbstractTCSDVOperation {
	...
	public ReportSubsidiaryListSOAOperation() {
	}
...
//        System.out.println("ccObject : "+ccObject.toString());
		...
		ds.put("typeOfReport", "Subsidiary Material List Report");
