...
public class ReportSubsidiaryAllListOperation extends SimpleSDVExcelOperation implements Comparator<HashMap<String, Object>> {
    ...
    public ReportSubsidiaryAllListOperation() {
    }
                                ...
                                if (childLine.parent() != null) {
                                    ...
                                    if (parent.parent().parent().getItem().getType().equals("M7_BOPLine")) {
                                        ...
                                        if (paintLine != null && !paintLine.isEmpty()) {
                                             ...
                                             *  
                                             *  편성버전이 "00" 이 아니더라도 부자래 리스트를 추출 할 수 있게 조건문 제거
                                             */
                                               dataMap = getSubsidiaryInfo(childLine, type, dataMap);
                                        }
                                    }
