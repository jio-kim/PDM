...
/**
 * Class 설명 :  MPP 상에서 Report 메뉴의 사이트 메뉴중 Tool Master List(On Server) 클릭시 동작 
 * 				
 * 
 * 
 * @author 178650
 *
 */
public class ReportToolMasterListSOAOperation extends AbstractTCSDVOperation {
	...
	public ReportToolMasterListSOAOperation() {
	}
	...
	public void startOperation(String commandId) {
		...
		System.out.println("ToolMasterListSOAOperation : startOperation");
	...
	public void executeOperation() throws Exception {
		...
		System.out.println("ToolMasterListSOAOperation : executeOperation");
		
		if(mode != 1){
			System.out.println("ToolMasterListSOAOperation : Cancle()");
...
//        System.out.println("ccObject : "+ccObject.toString());
		...
		ds.put("typeOfReport", "Tool Master List Report");
...
//			MessageBox.post(AIFUtility.getActiveDesktop().getShell(), messageStr, "Succeed", MessageBox.INFORMATION);		            
	...
	public void endOperation() {
		...
		System.out.println("ToolMasterListSOAOperation : endOperation");
