 ...
 * 
 */
public class CreateLineDialogOperation extends AbstractTCSDVOperation implements IDialogOpertation {

    private static final Logger logger = Logger.getLogger(CreateLineDialogOperation.class);
        ...
        try {
            ...
            if (itemRevisionType != null) {
                ...
                if (!itemRevisionType.equals(SDVTypeConstant.PLANT_SHOP_ITEM_REVISION)) {
                    opareaMessage = "PlantLine must be added Shop.";
                    isValidOK = false;
                    return;
                }
