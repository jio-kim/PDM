...
public class ReportECOChangeHistoryOperation extends SimpleSDVExcelOperation {

    public ReportECOChangeHistoryOperation() {
    ...
    protected IDataSet getData() throws Exception {
        ...
        IDataSet dataSet = convertToDataSet("ECOChangeHistoryList", dataList);
    ...
    public void executeOperation() throws Exception {
        try {
            ...
            if (dataSet != null) {
                String defaultFileName = "ECOChangeHistoryList" + "_" + ExcelTemplateHelper.getToday("yyyyMMdd");
