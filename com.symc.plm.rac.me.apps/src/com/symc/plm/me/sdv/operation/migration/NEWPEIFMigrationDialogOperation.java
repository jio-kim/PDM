...
import com.symc.plm.me.sdv.dialog.migration.NEWPEIFMigrationDialog;
 ...
 *
 */
public class NEWPEIFMigrationDialogOperation extends AbstractTCSDVOperation implements IDialogOpertation {
    ...
    public void executeOperation() throws Exception {
        try {
            ...
            NEWPEIFMigrationDialog migDialog = new NEWPEIFMigrationDialog(AIFUtility.getActiveDesktop().getShell(), processLine);
            migDialog.open();
            ...
            MessageBox.post(AIFDesktop.getActiveDesktop().getShell(), exception.getMessage(), "NEW PE I/F", status);
        }
    }
