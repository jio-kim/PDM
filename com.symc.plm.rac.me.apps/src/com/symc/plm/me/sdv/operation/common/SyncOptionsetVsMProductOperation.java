...
/**
 * Class Name : SyncOptionsetVsMProductOperation
 * Class Description : M Prdoduct에 정의된 옵션을 Update 하는 Operation
 * 
 * @date 2013. 10. 28.
 * 
 */
public class SyncOptionsetVsMProductOperation extends AbstractSDVActionOperation {
     ...
     * @param dataSet
     */
    public SyncOptionsetVsMProductOperation(int actionId, String ownerId, IDataSet dataSet) {
