...
/**
 * Class Name : CreatePaintLineDialogOperation
 * Class Description : 
 * @date 2013. 12. 2.
 *
 */
public class CreatePaintLineDialogOperation extends AbstractTCSDVOperation implements IDialogOpertation {
    private static final Logger logger = Logger.getLogger(CreatePaintLineDialogOperation.class);
