...
//  private List<VariantValue> values;
    ...
    public List<VariantValue> getValues() {
        ...
        Collection<VariantValue> collection = valueMap.values();
        ArrayList<VariantValue> list = new ArrayList<VariantValue>();
    ...
    public void addValue(VariantValue value){
        ...
        if( valueMap == null){
            valueMap = new HashMap<String, VariantValue>();
        }
    ...
    public void addValues(HashMap<String, VariantValue> newValues){
        ...
        Collection<VariantValue> collection = newValues.values();
